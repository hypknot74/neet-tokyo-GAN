...
if __name__ == "__main__":
    ...
    name = args.name
    ckpt_path = args.ckpt # path to the checkpoint
    ...
    video_name = f'videl_keyframe_{name}'  # name of the generated video

    model_type = 'freeform'
    net = Generator_freeform(ngf=64, nz=nz, im_size=im_size)
    ...
    noises = torch.randn( nbr_key_frames_total , nz).to(device)
